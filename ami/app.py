...
from ami.blueprints.admin import admin
from ami.blueprints.page import page
from ami.blueprints.contact import contact
from ami.blueprints.user import user
from ami.blueprints.user.models import User
from ami.extensions import (
    debug_toolbar,
    #mail,
    csrf,
    db,

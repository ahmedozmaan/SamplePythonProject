...
from ami.blueprints.contact.forms import ContactForm
...
def index():
    ...
    if form.validate_on_submit():
        ...
        from ami.blueprints.contact.tasks import deliver_contact_email
    ...
    return render_template('contact/demand.html', form=form)
